...
public class LogGUI {
    ...
    public void logConstructor() {
        ...
        bottomPanel.add(logBut, gbc_logBut);
        ...
        JLabel title = new JLabel("Welcome to Arye's Expense Manager");
        ...
        logBut.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String tempU = UField.getText();
                String tempP = PField.getText();
                if (dc.authenticateUser(tempU, tempP)) {
                    frame.setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(null, "Incorrect User or Pass", "ALERT", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        createBut.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                frame.setVisible(false);
                CreateGUI Clog = new CreateGUI();
                Clog.createConstruct();
                Clog.createInit();
            }
        });

        //adds panel to frame
        System.out.println("Got all the way through");
